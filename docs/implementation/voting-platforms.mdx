...
Here, we discuss some popular software packages for running online <Acronym acronym="PB" tooltip="Participatory Budgeting" /> voting platform, and how they are compatible with the Method of Equal Shares.
...
<img src="../img/screenshot-standfordpb.png" width="600" style={{ boxShadow: '0 0 15px rgba(0,0,0,0.3)' }} />
