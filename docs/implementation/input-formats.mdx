...
Wikipedia has a [list of cities using participatory budgeting](https://en.wikipedia.org/wiki/List_of_participatory_budgeting_votes) which mentions the input format used in each case.
