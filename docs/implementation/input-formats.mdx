...
* there are some very expensive projects, because then knapsack voting does not allow voters to express detailed preferences for these projects (because they can only choose few of them). This may lead to worse election outcomes.
:::
