...
* **Approval voting** (for example, voters can choose up to 10 projects)
* **Distributing points** (for example, voters can distribute 10 points between projects, being allowed to give several points to the same project)
* **Knapsack voting** (voters can choose as many projects as they like, as long as the total cost of the chosen projects does not exceed the budget limit)
* **Ranked voting** (for example, voters can rank 3 projects in order of preference)
...
* Advantage: the Method of Equal Shares is particularly easy to explain to voters when using approval
...
Another possibility to consider is to not impose *any* maximum number of votes. This has a number of advantages:
...
Lausanne: minimum 3 (2022). Toulouse (2019) implicitly also had a 3-project minimum.
Advantage: voters who are planning to vote for just 1 project will be encouraged to engage with the entire list of projects.
Disadvantage: there may be voters who legitimately want to vote for just 1 project, and it could be frustrating for them to be forced to vote for projects that they do not wish to support.
...
Knapsack voting is difficult for voters to use when a large number of projects fit within the budget limit.
In addition, when there are some very expensive projects, knapsack voting does not allow voters to express detailed preferences for these projects (because they can only choose few of them). This may lead to worse election outcomes.
:::
