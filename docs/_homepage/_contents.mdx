...
<section className={styles.contentSection}>
  ...
  <p style={{ fontSize: '1.2em' }}>
      This website was <Link to="contacts">constructed and is maintained by Dominik Peters (CNRS, Université Paris Dauphine-PSL) and Piotr Skowron (University of Warsaw)</Link>.
