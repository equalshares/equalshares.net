...
Azonban az általános szavazási rendszer nem értékelős szavazáson alapul, mert Párizs a ["többségi ítélet" szavazási módszert](../benefits/comparisons#majority-judgment) alkalmazza.
