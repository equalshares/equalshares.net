...
Gyakran minden lakos csak a saját kerületében szavazhat ötletekre.
A város az összköltségvetés egy részét (általában a kerület népességével arányosan) az egyes kerületekhez rendeli, és a nyertes ötleteket kerületenként külön állapítják meg.
Egyes városok ezen felül szerveznek egy választást kizárólag városszintű ötletekre is (olyan ötletekre, amelyek nem kötődnek egy adott kerülethez).
