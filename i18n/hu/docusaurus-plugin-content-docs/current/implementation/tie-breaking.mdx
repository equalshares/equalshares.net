...
<div class="summary">
<b>Összefoglaló</b>:
Ritka esetben előfordulhat, hogy két vagy több ötlet között döntetlen alakul ki (például azért, mert pontosan ugyanannyi a költségük és ugyanannyi szavazatot kaptak).
...
Ha azonban mégis valódi döntetlen alakul ki, azt a szervezőknek sorsolással érdemes feloldaniuk.
</div>
