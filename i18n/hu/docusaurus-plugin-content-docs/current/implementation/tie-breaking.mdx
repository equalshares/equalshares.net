...
Az egyenlő részvétel módszerének használata során döntetlen akkor fordulhat elő, ha két vagy több projekt azonos effektív szavazatszámmal rendelkezik.
...
Azt javasoljuk, hogy ha két vagy több projekt között döntetlen alakul ki az azonos effektív szavazatszám miatt a módszer valamelyik lépésében,
...
1. A választási eredmény kiszámítása előtt a választási tisztviselők ellenőrzik, hogy vannak-e olyan ötletek, amelyek költsége és kezdeti szavazatszáma azonos. Minden ilyen lehetséges döntetlenhez egy sorrendet állapítanak meg, például kalapból való névsorsolással.
