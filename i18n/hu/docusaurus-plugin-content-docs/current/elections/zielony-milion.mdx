...
# Wieliczka Zielony Milion ("Green Million") 2023
...
| Alapadatok | |
| --- | --- |
| Település | Wieliczka, Lengyelország ([wikipedia](https://en.wikipedia.org/wiki/Wieliczka), [térkép](https://www.google.com/maps/place/Wieliczka,+Poland/@49.9875288,19.9637094,12z/)) |
| Hivatalos weboldal | https://zb.wieliczka.eu/budzet-obywatelski |
| Szavazás dátuma | 2023-04-26 |
| Közösségi költségvetés címe | Zielony Milion (Zöld Millió) |
| Költségvetés összege | PLN 1 000 000 |
| Szavazók száma (érvényes) | 6586 |
| Szavazólapon szereplő ötletek száma | 64 |
| Nyertes ötletek száma  | 30 |
| Különleges tematika | Ökológiai és környezetvédelmi ötletek |
| Szavazási módszer | Egyenlő részvétel módszere (Method of Equal Shares) |
| Szavazólap típusa, bemeneti forma | Több X-es szavazás (maximum nélkül, korlátlan számú ötlet támogatható) |
| Szavazási módszer részletei | "Plusz1" completion, összehasonlító lépés |
...
<b>Fewer excluded voters.</b> Using the Method of Equal Shares, 18% of voters did not receive any of the projects they voted for. If the standard voting method were used, this percentage would be as high as 28%. This means that thanks to the Method of Equal Shares,
...
Among voters who voted for at least two projects, the percentage of those who did not receive any projects is only 9% (with the standard voting method, it would be 15%).
...
<li> 
<b>No regional bias.</b> Based on GPS coordinates, we marked projects on the map of Wieliczka that were selected using the Method of Equal Shares (blue map on the left)
and which would be selected using the standard voting method (red map on the right). The size of the circles marked on the map corresponds to the cost of the selected projects. If the standard voting method were used, the southern part of the municipality would be left without projects.
<b>Thanks to the Method of Equal Shares, we see a more even distribution of projects; in particular, we see that the residents of Byszyce and Gorzków and the western part of the municipality were not excluded from the decision-making process</b>, which would be the case if the standard voting method were used.
</li>
...
<li style={{ marginBottom: '10px' }}>
<b>Better distribution of voter satisfaction</b>. The chart below shows the distribution of voter satisfaction. For example, with the Method of Equal Shares, 45% of voters received
...
if we look at the amount each voter decided, the standard deviation of these values decreased by 18% compared to the standard voting method.
</li>

<Datawrapper src="//datawrapper.dwcdn.net/U98QD/2/" />

<li style={{ marginBottom: '10px' }}>
<b>Különböző méretű ötleteknek egyenlő esélye van nyerni</b>.
...
Alul egy oszlopdiagram arról, hogy mennyi ötletek támogattak a szavazók. (A szavazók tetszőleges számú ötletre szavazhattak, és egyes szavazók mind az 64 szavazólapon szereplő ötletre szavaztak) Például 3328 szavazó támogatott csak egy ötletet, 1456 támogatott kettőt, stb.

<Datawrapper src="//datawrapper.dwcdn.net/T38Dp/1/" />

## Külső linkek (lengyelül)

* [Eredmények hivatalos oldala](https://zb.wieliczka.eu/budzet-obywatelski)
* YouTube: [Eredményhirdetés](https://www.youtube.com/watch?v=OBbbMHHVwbo) [12:25 min] (2023-04-26)
* Rzeczpospolita (sajtómegjelenés): ["Are we facing a revolution in participatory budgeting?"](https://www.rp.pl/polityka/art38409241-czy-czeka-nas-rewolucja-w-budzetach-obywatelskich) (2023-04-28)
