...
Auf Wikipedia finden Sie [eine Liste von Städten, die Bürgerbudgets verwenden](https://en.wikipedia.org/wiki/Draft:List_of_participatory_budgeting_votes), in der auch das jeweils verwendete Input-Format erwähnt wird.
