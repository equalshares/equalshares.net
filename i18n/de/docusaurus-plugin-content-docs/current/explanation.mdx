...
**Endresultat**: Die gewinnenden Projekte sind die <span className="project-2">🏋️ Sportgeräte</span>, der <span className="project-3">🌳 Neue Park</span>, und der <span className="project-4">🛝 Neuer Spielplatz</span>.
