...
Suppose the overall budget is <Currency>110</Currency>, and there are 11 voters.
...
The two voters able to pay <Currency>60.5</Currency> each count as a full vote, while the three voters able to pay <Currency>43</Currency> each count as only a fraction of the vote, namely 0.7 each (because <Currency>43</Currency>/60.5 &approx; 0.7). Thus we have:

| Project            | Costs    | 👤 | 👤 | 👤 | 👤 | 👤 | 👤 | 👤 | 👤 | 👤 | 👤 | 👤 | effective vote count |
|--------------------|---------|---|---|---|---|---|---|---|---|---|---|---|---|
| <span className="project-1">🚲 bike path      </span> | <Currency>700</Currency> | — | — | — | — | — | — |   |   |   |   |   | **0** |
| <span className="project-3">🌳 new park       </span> | <Currency>250</Currency> |   | ✗ |   | ✗ | ✗ |   | ✗ |   |   | ✗ |   | **4.1** |
| <span className="project-4">🛝 new playground </span> | <Currency>200</Currency> |   |   |   |   |   |   | ✗ | ✗ | ✗ | ✗ |   | 4 |
| <span className="project-5">📚 library for kids</span> | <Currency>100</Currency> |   |   |   |   |   |   | ✗ |   | ✗ | ✗ |   | 3 |
