...
2. Wir <SemiBold>streichen</SemiBold> alle Projekte, die mehr kosten also die kombinierten Anteile der Wähler, die für das Projekt gestimmt haben. Diese Projekte können nicht gewinnen.
:::tip Beispiel
...
Bei der Ermittlung der Gewinnerprojekte nach der Methode der gleichen Anteile geht es vor allem darum, die Kosten eines Projekts so *gleichmäßig wie möglich* aufzuteilen. In diesem Abschnitt erklären wir, was das bedeutet.
...
## Beispiel 1 {#example}
Lassen Sie uns die Methode anhand eines kleinen Beispiels erläutern. Angenommen, das Gesamtbudget beträgt <Currency>110</Currency> und es gibt 11 Wähler.
...
**Endresultat**: Die gewinnenden Projekte sind der <span className="project-1">🚲 Fahrradweg</span>, der <span className="project-4">🛝 Neuer Spielplatz</span>, und die <span className="project-5">📚 Kinderbücherei</span>.
...
In der nächsten Runde wird der <span className="project-4">🛝 Neuer Spielplatz</span> gewählt werden, mit einer effektiven Stimmenzahl von 3.2 (was die höchste ist):
