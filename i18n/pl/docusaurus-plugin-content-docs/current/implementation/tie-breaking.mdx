...
(Dzieje się tak w przypadku [standardowego wariantu uzupełniania wyników obliczonych przez metodę równych udziałów](implementation/completion)).
...
Okazuje, że wyjątkowo rzadko (<0,1%) zachodzi potrzeba losowania.
...
Jeśli takie projekty istniały, sprawdzaliśmy, czy metoda równych udziałów (wykorzystująca standardową metodę [uzupełniania](implementation/completion)) napotka remis.
