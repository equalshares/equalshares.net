...
Oczywiście najczęściej wolelibyśmy wydać około 100% budżetu.
...
<details>
<summary><SemiBold>Wykres</SemiBold>: Uzupełnianie może nie być konieczne, jaśli ka żdy z wyborców głosuje na wiele projektów.</summary>
...
Wtedy wykorzystując 70% przyznanych środków, wybraibyśmy projekty, które łącznie kosztują 0,7 &middot; <Currency>140 000</Currency> = <Currency>98 000</Currency>.
